...
const Auth = (state = initialState, action) => {
  switch (action.type) {
    ...
    case SET_NOTIFICAITON_COUNT:
      return {
        ...state,
        notificationcountVal: action.payload,
      };
    ...
    case GET_ALL_NOTIFICAITON:
      return {
        ...state,
        getlistnotification: action.payload,
      };
