              ...
              <TouchableOpacity
                  ...
                  <View style={tw.style('flex flex-row justify-center items-center')}>
                      <Image source={ImageIcons.googleicon} style={tw.style('w-8 h-8')} />
                        <Text style={tw.style('text-xl ml-3 text-gray-800 tracking-wide', { fontFamily: "hintedavertastdsemibold" })}>Sign in with Google</Text>
                  </View>
              </TouchableOpacity>
          </View>
        ...
        <View style={[styles.devider1, { marginTop: '10%' }]}>
            ...
            <View style={tw`mx-5 mt-10`}>
              <Largebutton
                ...
                onPress={() => props.navigation.navigate("createselleraccount")}
              />
            </View>
