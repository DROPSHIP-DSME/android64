...
<p>Dropship App (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by Dropship App.</p>
<!-- /wp:paragraph --><!-- wp:paragraph -->
<p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application, Dropship App. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.</p>
        ...
        <KeyboardAwareScrollView style={styles.registrationRootscroll}>
            ...
            <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
                ...
                <View style={tw.style('mx-5 mb-0 mt-3')}>
                    <Text style={tw.style('text-3xl text-gray-700',{fontFamily:'AvertaStd-Semibold'})}>Privacy Policy</Text>
                </View>
