    ...
    return (
       ...
       <ScrollView onScroll={({nativeEvent}) => {
               ...
               <View style={tw.style('flex flex-row justify-between mx-4 my-10')}>
                 <Text style={tw.style('text-3xl text-gray-700 tracking-wide', {fontFamily:'AvertaStd-Semibold'})}>Settings</Text>
               </View>
              ...
              <View style={tw.style('bg-white overflow-hidden shadow rounded-md mx-4 mb-10')}>
                <View style={tw.style('px-2 py-8')}>
                    ...
                    <View style={tw.style('flex flex-row justify-between px-4')}>
                        <Text style={tw.style('text-2xl text-gray-700',{fontFamily:'AvertaStd-Semibold'})}>Brand Profile</Text>
              ...
              <View style={tw.style('bg-white overflow-hidden shadow rounded-md mx-4 mt-0 mb-10')}>
                <View style={tw.style('px-2 py-8')}>
                    ...
                    <View style={tw.style('flex flex-row justify-between px-4')}>
                        <Text style={tw.style('text-2xl text-gray-700', {fontFamily:'AvertaStd-Semibold'})}>Account Settings</Text>
                    </View>
