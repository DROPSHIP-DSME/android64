  ...
  return (
    <View style={tw.style('mt-20 mb-10 mx-5')}>
      ...
      <View style={tw.style('mb-1 mx-5')}>
        <Text style={tw.style('text-3xl text-gray-700 text-center', {fontFamily:"AvertaStd-Semibold"})}>Payment</Text>
      ...
      <View style={tw.style('bg-white flex rounded-t-lg justify-between')}>
        ...
        <Text style={tw.style('text-xl text-gray-700 text-center my-3', {fontFamily: 'AvertaStd-Semibold'})}> You shopping Total $40.00 plus shipping</Text>
