        ...
        return (
            <View>
                ...
                <View style={tw`rounded-md absolute bottom-16 right-4 bg-white p-2`}>
                    {( props?.getfavproduct && props?.getfavproduct.indexOf(item.products[0]?._id) > -1) ?
         ...
         <View style={{flex:1}}>
            ...
            <ScrollView onScroll={({ nativeEvent }) => {
                ...
                <View style={tw`flex flex-row justify-between mx-4 mt-10 mb-5`}>
                    <Text style={tw.style('text-3xl text-gray-700', {fontFamily: 'AvertaStd-Semibold', })}>Bookmarks</Text>
                </View>
