...
const Blurbackgrounddemo = (props) => {
    ...
    const hidesidebar = () => {
       setshowsidebar(false)
        ...
        const containerStyledemo = { position: 'absolute', borderRadius:10, top: '30%', width: '90%', backgroundColor: '#FFFFFF', padding: '1%', marginHorizontal: '5%', alignItems: 'center' };
    ...
    const endStream = async() => {
        if (isbroadcaster) {
            ...
            props.navigation.navigate("watchlistdemo")
        }
    }
            ...
            <KeyboardAvoidingView behavior={Platform.OS == 'ios' ? 'padding' : undefined} style={styles.container}>
                ...
                <View style={tw`flex flex-1 justify-end mx-2`}>
                    ...
                    <View style={tw`flex flex-row justify-between items-center mx-3`}>
                        <TouchableOpacity onPress={() =>  openfooterpopup() } >
                        <View style={styles.box}>
                            <Text style={{ padding:10, color:'#c3c3c3',marginHorizontal:20}}>Sign In to Chat</Text>
                        </View>
                        </TouchableOpacity>
