...
stwtxt:{
  color:"#1A1A1A",fontSize:14,fontFamily:'AvertaStd-Regular',fontWeight:"bold"
},
 tickmarkview:{
  ...
  leftIconwhite: {
    ...
    chatinput: {
       backgroundColor:'#E6E6E6',borderRadius:10,paddingLeft:'5%',fontSize:11.3,lineHeight:14,letterSpacing:-0.125172,width:'75%',color:'#878787',fontWeight:'normal',fontStyle:'normal',fontFamily:'AvertaStd-Regular'
    },
    chatsupportimgView:{
    ...
    devider3:{
        alignSelf:'center', fontFamily: 'AvertaStd-Regular',paddingHorizontal:20, fontSize: 12, color:'#808080'
    },
    message1: {
   ...
   sellbutton:{
        textAlign:'center',fontSize:15,fontFamily:'AvertaStd-Regular',
...
buyertext:{
    ...
    fontWeight:'normal',fontStyle:'normal',fontFamily:'AvertaStd-Regular',
    letterSpacing:0.5,
},
pricebrandtext:{
...
brandcolortext:{
   color:'#919191',fontSize:10,lineHeight:13,
    fontWeight:'normal',fontStyle:'normal',fontFamily:'AvertaStd-Regular',marginRight:'13%'
},
crt1:
{
...
confirmtexxt:{
    ...
    fontFamily:'AvertaStd-Regular',fontStyle:'normal',lineHeight:15,
},
textshipcheck:{
    fontSize:11,color:'#000000',fontWeight:'normal',letterSpacing:0.5,
    marginVertical:'2%',paddingHorizontal:'2%',
    fontFamily:'AvertaStd-Regular',fontStyle:'normal',lineHeight:14,textAlign:'center'
},
greecolortext:{
...
adcartcolortext:{
    fontSize:12,color:'#FFFFFF',fontWeight:'normal',padding:'1%',textAlign:'center',
    fontFamily:'AvertaStd-Regular',fontStyle:'normal',lineHeight:15,paddingHorizontal:'2%'
},
proceedtext:{
...
crt20:{paddingTop:"5%",paddingLeft:'10%',color:'#ffffff',fontSize:12,fontWeight:'bold',fontFamily:'AvertaStd-Regular'},
...
inorder12:{
    fontSize:13,marginLeft:'2%',fontFamily: "AvertaStd-Regular",fontStyle: "normal",fontWeight:'600',
},
...
livec28:{textAlign:'center' ,fontSize:8,paddingTop:'3%',color:"#ffffff",fontFamily: "AvertaStd-Regular",fontStyle: "normal",fontWeight:'normal'},


livec12:{textAlign:'center',fontSize:12 ,color:"#0B0022",fontWeight:'normal',fontFamily: "AvertaStd-Regular",fontStyle: "normal"},

livec13:{textAlign:'center' ,padding:5,color:"#ffffff",fontSize:12 ,fontWeight:'normal',fontFamily: "AvertaStd-Regular",fontStyle: "normal"},
...
norecord:{fontSize:12,paddingHorizontal:100,color:"#4F4F4F",fontWeight:'normal',fontStyle:'normal',fontFamily:'AvertaStd-Regular'},


over14:{fontSize:12,marginHorizontal:'36%',color:"#4F4F4F",fontWeight:'400',fontStyle:'normal',fontFamily:'AvertaStd-Regular'},
...
over26:{fontSize:12,color:"#4F4F4F",fontWeight:'normal',fontStyle:'normal',fontFamily:'AvertaStd-Regular'},
...
tops2:{fontSize:16,marginLeft:'20%',fontWeight:'600',fontFamily:'AvertaStd-Semibold',fontStyle:'normal'},
  ...
  Touchablestarttext:{
    ...
    textbrand:{
       ...
       fontStyle:'normal',fontFamily:'AvertaStd-Regular',fontWeight:'normal',color:'#FFFFFF'
    },
    textexp:{
       fontSize:15,marginTop:'4%',textAlign:'center',lineHeight:19,marginHorizontal:'19%',
       fontStyle:'normal',fontFamily:'AvertaStd-Regular',fontWeight:'normal',color:'#000000'
    },
    textexpext:{
       fontSize:18,marginTop:'4%',textAlign:'center',lineHeight:19,marginHorizontal:'19%',
       fontStyle:'normal',fontFamily:'AvertaStd-Regular',fontWeight:'normal',color:'#666666'
    },
    logintxet:{
    ...
    newstext:{
       ...
       fontStyle:'normal',fontFamily:'AvertaStd-Regular',fontWeight:'300',
    },
    ortext:{
    ...
    ortextnew:{
       fontSize:10,alignItems:'center',marginTop:'4%',textAlign:'center',lineHeight:13,
       fontStyle:'normal',fontFamily:'AvertaStd-Regular',fontWeight:'normal',color:'rgba(255,255,255,0.4)'
    },
    Benrosetext:{
  ...
  color:'#E22020',fontFamily:'AvertaStd-Semibold',lineHeight:15,
    ...
    moretbutton:{
        textAlign:'center',fontSize:14,fontFamily:'AvertaStd-Regular',fontStyle:'normal',
...
shoptextred:{
   ...
   color:'#E22020',textAlign:'right',fontFamily:'AvertaStd-Regular'
},
cartView:{
      height:202,width:'47%',
...
optext:{
    fontSize:16,fontFamily:'AvertaStd-Regular',marginLeft:5
},
dashbtn:{
...
nametxt:{
  fontSize:32,fontFamily:'AvertaStd-Semibold',textAlign:'center',color:"#b80000",marginTop:'2%'
},
abouttxt:{
  fontSize:18,fontFamily:'AvertaStd-Regular',textAlign:'center',color:'#1a1a1a',marginVertical:5
},
arroundview:{
...
stlinetxt:{
  fontSize:16,fontWeight:"bold",fontFamily:"AvertaStd-Regular",color:"#1A1A1A"
},
nolvtxt:{
  fontSize:16,fontWeight:"bold",fontFamily:"AvertaStd-Regular",color:"#999999"
},
fitrtxt:{
  fontSize:16,fontFamily:'AvertaStd-Regular',textAlign:'center',color:'#000000'
},
zerotxt:{
  fontSize:22,fontFamily:'AvertaStd-Semibold',textAlign:'center',color:"#1a1a1a"
},
stremtxt:{
  fontSize:16,fontFamily:'AvertaStd-Regular',textAlign:'center',color:"#1a1a1a"
},
...
storecamtext:{
    fontSize:15,fontWeight:'normal',fontFamily:'AvertaStd-Regular',fontStyle:'normal',
    color:'#000000',textAlign:'center',marginHorizontal:'7%'
},
storecamtexttodayy:{
    fontSize:18,fontWeight:'normal',fontFamily:'AvertaStd-Regular',fontStyle:'normal',
...
produttext:{
  ...
  marginVertical:'10%',fontStyle:'normal',fontFamily:'AvertaStd-Semibold',
...
recodingtextmint:{
   fontSize:10,color:'#FFFFFF',fontFamily:'AvertaStd-Regular',
  letterSpacing:0.5,padding:'2%',paddingHorizontal:'3%',
  fontWeight:'normal',fontStyle:'normal',
},

recodingtext2:{
   fontSize:10,color:'#828282',fontFamily:'AvertaStd-Regular',alignItems:'center',
  letterSpacing:0.5,alignSelf:'center',color:'#000000',
  marginHorizontal:'2%',fontWeight:'normal',fontStyle:'normal',
},
recodingtextred:{
   fontSize:10,color:'#E22020',fontFamily:'AvertaStd-Regular',alignItems:'center',
  letterSpacing:0.5,alignSelf:'center',padding:'2%',lineHeight:13,
  fontWeight:'normal',fontStyle:'normal',
},
addimagetext:{
  fontSize:12,fontWeight:'600',fontStyle:'normal',
  lineHeight:15,fontFamily:'AvertaStd-Regular',color:'#828282',textAlign:'center'
},
updateordertext:{
  fontSize:12,fontWeight:'600',fontStyle:'normal',marginHorizontal:'3%',
  lineHeight:15,fontFamily:'AvertaStd-Regular',color:'#828282',
},
checkboxtext:{
  fontSize:12,fontWeight:'500',fontStyle:'normal',marginHorizontal:'3%',
  lineHeight:14,fontFamily:'AvertaStd-Regular',color:'#000000',marginTop:'2%'
},
...
buyertext2:{
    ...
    letterSpacing:0.5,fontStyle:'normal',fontWeight:'normal',fontFamily:'AvertaStd-Regular'
},
supporttext:{
...
beautytext:{
   ...
   fontSize:14,fontStyle:'normal',fontFamily:'AvertaStd-Regular',
...
searchproducttext:{
    fontSize:12,fontWeight:'bold',fontStyle:'normal',fontFamily:'AvertaStd-Semibold',
...
selecttstext:{
    fontSize:14,fontWeight:'normal',fontStyle:'normal',fontFamily:'AvertaStd-Regular',
    marginHorizontal:'3%',color:'#686868',
},
namebrandtext:{
   fontStyle:'normal',fontFamily:'AvertaStd-Regular',fontSize:16,
...
bluepricetext:{
  ...
  fontFamily:'AvertaStd-Regular',letterSpacing:0.5,color:'#0C7CFF'
},
TEXT:{
    fontSize:14,marginHorizontal:'2%',color:'#000000',fontWeight:'normal',
    fontStyle:'normal',fontFamily:'AvertaStd-Regular',
...
storebuttontext:{
   ...
   fontStyle:'normal',fontFamily:'AvertaStd-Semibold',color:'#FFE7E7',textAlign:'center'
},
TEXT2:{
...
CHANGETEXTTITLE:{
  ...
  fontFamily:'AvertaStd-Regular',color:'#4F4F4F',marginHorizontal:'3%',marginTop:'1%'
},
startrecordtext:{
  fontSize:12,fontWeight:'normal',fontStyle:'normal',
  fontFamily:'AvertaStd-Regular',color:'#4F4F4F',marginHorizontal:'5%',
},
Degaretext:{
  fontSize:15,fontWeight:'600',fontStyle:'normal',marginVertical:'1%',width:'80%',
  fontFamily:'AvertaStd-Regular',lineHeight:19,color:'#4F4F4F',textAlign:'center'
},
DeGaulleView:{
...
viewdegaulletext:{
   fontSize:12,fontWeight:'normal',fontStyle:'normal',
   fontFamily:'AvertaStd-Regular',color:'#4E4E4E',marginVertical:'4%',marginHorizontal:'4%',
},
viewdegaulletextcenter:{
   fontSize:12,fontWeight:'normal',fontStyle:'normal',
   fontFamily:'AvertaStd-Regular',color:'#4E4E4E',marginVertical:'4%',marginHorizontal:'5%',
},
Linesorttext:{
   fontSize:13,color:'#4E4E4E',fontWeight:'normal',fontStyle:'normal',
   fontFamily:'AvertaStd-Regular',lineHeight:16
},
boderlineview:{
...
chattingtext:{
    ...
    fontFamily:'AvertaStd-Regular',letterSpacing:-0.125172,color:'#434343'
},
chatlongView:{
...
labeltext:{
    color:'#000000',fontFamily:'AvertaStd-Regular',fontWeight:'normal',
...
textshopcheck:{
    ...
    fontFamily:'AvertaStd-Regular',lineHeight:16,fontStyle:'normal'
},
beautyclaratext:{
...
beautygreytext:{
   fontSize:14,color:'#000000',fontWeight:'normal',marginLeft:'5%',
    fontFamily:'AvertaStd-Regular',lineHeight:18,fontStyle:'normal'
},
arrowimg:{
...
alreadytextblack:{
    ...
    fontFamily:'AvertaStd-Semibold',lineHeight:16,fontStyle:'normal'
},
alreadytext:{
...
livetext:{
    fontSize:8,fontWeight:'normal',fontStyle:'normal',
    fontFamily:'AvertaStd-Regular',color:'#E22020',lineHeight:9
},
DELIVERYTEXT:{
  fontStyle:'normal',color:'#828282',fontFamily:'AvertaStd-Regular',fontWeight:'normal',
...
accounttext:{
   fontSize:12,fontStyle:'normal',fontWeight:'normal',fontFamily:'AvertaStd-Regular',
   color:'#000000',
},
salesnewtext:{
  fontSize:12,fontStyle:'normal',fontWeight:'normal',fontFamily:'AvertaStd-Regular',
...
salestextbtn:{
    fontSize:12,fontStyle:'normal', width:'60%',fontWeight:'normal',fontFamily:'AvertaStd-Regular',
...
textseriessale:{
  ...
  color:'#828282',fontFamily:'AvertaStd-Regular',lineHeight:16
},
salesBottom:{
...
namestoretext:{
  ...
  color:'#000000',fontStyle:'normal',textAlign:'center'
    ...
    goshoptext:{
       ...
       fontFamily:'AvertaStd-Semibold',color:'#000000'
    },
    startbutton:{
    ...
    barlotext:{
        ...
        fontFamily:'AvertaStd-Regular',color:'#000000',lineHeight:19,marginHorizontal:'4%'
    },
    Modaltext:{
       fontSize:15,fontWeight:'bold',fontStyle:'normal',fontFamily:'AvertaStd-Regular',
       color:'#000000',letterSpacing:0.0075,
    },
    modaltouchablitytext:{
        fontSize:15,fontWeight:'500',fontStyle:'normal',
        fontFamily:'AvertaStd-Regular',lineHeight:18,color:'#FFFFFF',textAlign:'center'
    },
 ...
 fontFamily:'AvertaStd-Regular',lineHeight:13,position:'absolute',bottom:'15%',left:'5%',
},
    modalsuceestext:{
...
boldhadertext1:{
 ...
 recodingbutton:{
    ...
    fontStyle:'normal',fontFamily:'AvertaStd-Regular',lineHeight:19
},

storedropship:{
  color:"#E22020",fontSize:10,textAlign:'center',lineHeight:13,
  fontStyle:'normal',fontFamily:'AvertaStd-Regular',fontWeight:'normal'
},
upcomingtext:{
 fontSize:10,fontWeight:'normal',fontStyle:'normal',color:'#FFFFFF',
 fontFamily:'AvertaStd-Regular',
...
uppricetext:{
 fontSize:10,fontWeight:'normal',fontStyle:'normal',color:'#FFFFFF',
 fontFamily:'AvertaStd-Regular',textAlign:'center'
},
liketext:{
...
filterpop1:{
   fontSize:12,color:'#4D4D4D',
    fontFamily:'AvertaStd-Regular',fontStyle:'normal',
},
twotextview:{
...
clothpop:{
    fontSize:18,color:'#1A1A1A',paddingVertical:'1%',lineHeight:30,fontWeight:'bold',fontFamily:'AvertaStd-Regular',fontStyle:'normal',
},
clothpop1:{
...
dartxt:{
    ...
    fontWeight:'normal',fontFamily:'AvertaStd-Regular',fontStyle:'normal',
},
textviewpop:{
...
logouttext:{
    ...
    fontWeight:'bold',fontFamily:'AvertaStd-Regular',fontStyle:'normal'
},
feedsendtext:{
