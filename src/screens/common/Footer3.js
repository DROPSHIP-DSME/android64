    ...
    const Showaccountlinks = () => {
        ...
        return (
            <View>
                ...
                >
                    <ScrollView>
                        <View style={tw`pb-2 py-6`}>
                            <View style={tw`flex flex-row`}>
                                <TouchableOpacity style={tw`flex-row items-center w-full`} onPress={ () => navigation.navigate("Account")}>
                                    <View>
                                        <Image source={{ }} style={styles.produtbrandimage2} />
                                    </View>
                                    <View style={tw`ml-3`}>
                                        <Text style={styles.droptxttt}> Sample - Store</Text>
                                        ...
                                        <View style={tw.style('flex-row items-center ml-5')}>
                        ...
                        {/* if user has Stor then the following links will show */}
                        <View style={tw.style('flex flex-row inline-block mx-7 my-3 md:px-2 md:mx-6')}>
