...
const Footer2 = (props) => {
    ...
    const {
        ...
        const containerStyle = {backgroundColor: '#FFFFFF', marginHorizontal:40, padding: '7%',marginTop:-600,alignItems:'center'};
            ...
            <View style={tw.style('flex-row justify-between')}>
                ...
                <TouchableOpacity style={tw.style('px-2')} onPress={() => openpopup() }>
                    ...
                    <View style={tw.style('inline-block items-center px-2 mx-1 md:px-2 md:mx-2')}>
                        ...
                        <Text style={tw.style('text-sm text-right font-normal text-red-700')}>Home 4</Text>
                    </View>
                </TouchableOpacity>
